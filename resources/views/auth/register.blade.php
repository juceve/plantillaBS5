        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                <div class="col-lg-7 col-md-5 modal-bg-img"
                    style="background-image: url({{ asset('src/assets/images/register.avif') }});">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <img src="{{ asset('src/assets/images/logo.png') }}" alt="wrapkit" style="width: 80px">
                        <h2 class="mt-3 text-center">Nuevo Registro</h2>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn w-100 btn-dark">Registrar</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Ya tiene una cuenta? <a href="{{ route('login') }}" class="text-danger">Inicie
                                        Sesión</a>
                                </div>
                            </div>
                        </form>
